export const PERGUNTAS = [
    ...
    {
        titulo: "3. Sobre fluxo contínuo vs. eficiência local:",
        opcoes: [
            { id: 0, texto: "Fluxo contínuo sempre aumenta eficiência individual das máquinas" },
            { id: 1, texto: "Eficiência local deve sempre ser priorizada" },
            { id: 2, texto: "Fluxo contínuo pode reduzir eficiência local, mas melhora o desempenho global" },
            { id: 3, texto: "Não existe conflito entre os dois conceitos" }
        ],
        idCorreto: 2
    },
    {
    ...
    {
        titulo: "5. Sobre padronização e inovação:",
        opcoes: [
